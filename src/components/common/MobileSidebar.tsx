...
export default function MobileSidebar({ items, isOpen, onClose }: MobileSidebarProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex md:hidden" onClick={onClose}>
      ...
      >
        <h1 className="text-sm font-bold text-blue-900 dark:text-blue-200 text-center mb-4">MasjidKu</h1>
...
function ExpandableMenu({ item, isExpanded, toggleExpand, onClose }: ExpandableMenuProps) {
  const location = useLocation()
