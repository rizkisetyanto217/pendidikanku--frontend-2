...
const TryoutCard: React.FC<TryoutCardProps> = ({
  tryout,
  palette,
  onDetailClick,
}) => {
      ...
      <div className="p-5">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="text-sm">{tryout.pengawas.join(", ")}</div>
          </div>
        </div>
  ...
  const tryoutList: TryoutTahfiz[] = [
    {
      ...
      deskripsi:
        "Tryout internal Kamis depan. Mohon guru menyiapkan rubrik penilaian untuk evaluasi kemampuan tahfiz siswa semester ini.",
      status: "Akan Datang",
    ...
    },
    {
      ...
      deskripsi:
        "Ujian rutin bulanan untuk mengukur progress hafalan siswa. Meliputi evaluasi kelancaran, tajwid, dan makhorijul huruf.",
      status: "Akan Datang",
    ...
    },
    {
      ...
      deskripsi:
        "Persiapan khusus untuk siswa yang akan mengikuti Musabaqah Tilawatil Quran tingkat kota. Fokus pada teknik dan mental bertanding.",
      status: "Akan Datang",
    ...
    },
    {
      ...
      deskripsi:
        "Evaluasi komprehensif tahfiz untuk semester genap yang telah berlalu. Hasil akan menjadi dasar penentuan level tahfiz semester depan.",
      status: "Selesai",
      jenisTryout: "Ujian Resmi",
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
                  ...
                  >
                    <p className="text-2xl font-bold text-blue-600">
                      {
                        tryoutList.filter((t) => t.status === "Akan Datang")
                          .length
                      }
                    </p>
                  ...
                  >
                    <p className="text-2xl font-bold text-green-600">
                      {
                        tryoutList.filter((t) => t.status === "Berlangsung")
                          .length
                      }
                    </p>
                  ...
                  >
                    <p className="text-2xl font-bold text-gray-600">
                      {tryoutList.filter((t) => t.status === "Selesai").length}
                    </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-70 leading-relaxed">
                    Semua siswa wajib mengikuti tryout sesuai jadwal yang telah
                    ditentukan. Untuk informasi lebih lanjut, silakan hubungi
                    guru tahfiz atau bagian akademik.
                  </p>
                </div>
              </div>
            </SectionCard>
